...
The PWM scoring can be parallelized by supplying a `BiocParallelParam` object to the 'BPPARAM' parameter. 
...
Quantifying PWM matches by percentile rank was first described in Jaffe et al. 2001 [@Jaffe2001]. It is also the matching score underlying the kinase activity predictions published in Johnson et al.
